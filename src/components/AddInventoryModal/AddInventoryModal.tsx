  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const addStockParams = {
        ...
        quantity: quantity,
        unit_cost: unitCost,
        notes: notes || `Agregado por ${userRole} - ${new Date().toLocaleDateString()}`
      };
      ...
      setError('Error al agregar el inventario. Por favor, intente nuevamente.');
    } finally {
      setLoading(false);
    }
  };
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="modal-footer">
              ...
              >
                ...
                {loading ? 'Agregando...' : 'Agregar Inventario'}
              </button>
            </div>
          </form>
        </div>
